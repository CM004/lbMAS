...
class LongTermMemory(Memory):
    def __init__(self, db_path: str = "vectorstore/long_term.db"):
    ...
    def _init_db(self) -> None:
        ...
        conn.commit()
        conn.close()
        print(f"Long-term memory initialized at {self.db_path}")
    ...
    async def get_important_memories(
        ...
        """Get important memories by importance threshold"""
        conn = sqlite3.connect(self.db_path)
        cursor = conn.cursor()
